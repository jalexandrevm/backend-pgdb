export const paises: { [codigo: string]: string } = {
  "132": "AFEGANISTAO",
  "153": "ALAND, ILHAS",
...
export function getNomePaisPorCodigo(codigo: string): string | undefined {
  return paises[codigo];
}

export function getCodigoPaisPorNome(nome: string): string | undefined {
  const entry = Object.entries(paises).find(([, n]) => n.toUpperCase() === nome.toUpperCase());
